//
//  CaoCertificationingViewController.m
//  huoxiangserverapp
//
//  Created by mc on 17/9/5.
//  Copyright © 2017年 huoxiangTongWang. All rights reserved.
//

#import "CaoCertificationingViewController.h"

@interface CaoCertificationingViewController () {
    UILabel *onelabel;
    UILabel *twolabel;
    UILabel *threelabel;
}
...
@implementation CaoCertificationingViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor colorWithHexString:@"f0f2f8"];
    // Do any additional setup after loading the view.
    [self caocerwtTopViewWithBackString:@"取消" andTitlestring:@"店家认证"];
...
- (void)caocerwtTopViewWithBackString:(NSString *)backstring andTitlestring:(NSString *)titlestring {
    UIView *topView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, KscreeWidth, 64)];
    topView.backgroundColor = [UIColor whiteColor];
    [self.view addSubview:topView];
    UIButton *backButton = [UIButton buttonWithType:UIButtonTypeCustom];
    backButton.frame = CGRectMake(KscreeWidth - 20 - 40, 30, 40, 18);
    [backButton setTitleColor:[UIColor colorWithHexString:@"ff8042"] forState:UIControlStateNormal];
