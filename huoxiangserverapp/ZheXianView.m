...
- (void)createLabelY{
    ...
    for (NSInteger i = 0; i < Ydivision; i++) {
        ...
        labelYdivision.text = [NSString stringWithFormat:@"%.0f人",(Ydivision - i)*100];
...
//    self.gradientLayerColors = [NSMutableArray arrayWithObject:@[(__bridge id)[UIColor yellowColor].CGColor, (__bridge id)[UIColor yellowColor].CGColor]];
